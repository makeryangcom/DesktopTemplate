<template>
    <Popover>
        ...
        <PopoverContent :side-offset="11" align="end" class="w-96">
            <div class="p-2">
                <div class="grid space-y-1">
                    <h1 class="text-sm text-foreground font-semibold">定制主题</h1>
                    <p class="text-xs text-muted-foreground">选择你喜欢的样式和颜色主题</p>
                </div>
                <div class="space-y-1 pt-3">
                    <Label for="color" class="text-xs text-muted-foreground">颜色</Label>
                ...
                <div class="space-y-1 pt-3">
                    <Label for="radius" class="text-xs text-muted-foreground">半径</Label>
                ...
                <div class="space-y-1 pt-3">
                    <Label for="theme" class="text-xs text-muted-foreground">样式</Label>
